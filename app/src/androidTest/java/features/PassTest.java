...
public class PassTest extends GreenCoffeeTest {
    ...
    public static Iterable<ScenarioConfig> data() throws IOException {
        return new GreenCoffeeConfig().
                withFeatureFromAssets("assets/features/pass.feature").
                scenarios();
    }
