...
import steps.UserDontHavePreferenceAndFindMeASpot;

@RunWith(Parameterized.class)
public class UserDontHavePreferenceAndFindMeASpotFeatureTest extends GreenCoffeeTest {

    @Rule
    public ActivityTestRule<GuestDashboardActivity> activity= new ActivityTestRule<>(GuestDashboardActivity.class);

    public UserDontHavePreferenceAndFindMeASpotFeatureTest(ScenarioConfig scenario) {
        super(scenario);
    }
    ...
    public static Iterable<ScenarioConfig> data() throws IOException {
        return new GreenCoffeeConfig().
                withFeatureFromAssets("assets/features/userDontHavePreferenceAndFindMeASpot.feature").
                scenarios();
    }

    @Test
    public void test(){
        start(new UserDontHavePreferenceAndFindMeASpot());
    }
