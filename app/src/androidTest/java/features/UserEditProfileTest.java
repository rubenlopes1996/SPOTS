...
import steps.UserEditProfileSteps;

@RunWith(Parameterized.class)
public class UserEditProfileTest extends GreenCoffeeTest {
    @Rule
    public ActivityTestRule<GuestDashboardActivity> activity = new ActivityTestRule<>(GuestDashboardActivity.class);

    public UserEditProfileTest(ScenarioConfig scenario) {
        super(scenario);
    }
    ...
    public static Iterable<ScenarioConfig> data() throws IOException {
        return new GreenCoffeeConfig().
                withFeatureFromAssets("assets/features/userEditProfile.feature").
                scenarios();
    }

    @Test
    public void test(){
        start(new UserEditProfileSteps());
    }
