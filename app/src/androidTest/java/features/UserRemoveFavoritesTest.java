...
public class UserRemoveFavoritesTest extends GreenCoffeeTest {
    ...
    public static Iterable<ScenarioConfig> data() throws IOException {
        return new GreenCoffeeConfig()
                .withFeatureFromAssets("assets/features/userRemoveFavorites.feature")
                .scenarios();
    }

    @Test
    public void test(){
        start(new UserRemoveFavoritesSteps());
    }
