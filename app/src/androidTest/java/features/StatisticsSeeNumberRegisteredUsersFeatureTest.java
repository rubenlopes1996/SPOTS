...
import steps.StatisticsSeeNumberRegisteredUsersSteps;

@RunWith(Parameterized.class)
public class StatisticsSeeNumberRegisteredUsersFeatureTest extends GreenCoffeeTest {
    @Rule
    public ActivityTestRule<GuestDashboardActivity> activity=new ActivityTestRule<>(GuestDashboardActivity.class);

    public StatisticsSeeNumberRegisteredUsersFeatureTest(ScenarioConfig scenario) {
        super(scenario);
    }
    ...
    public static Iterable<ScenarioConfig> data() throws IOException {
        return new GreenCoffeeConfig().
                withFeatureFromAssets("assets/features/statisticsSeeNumberRegisteredUsers.feature").
                scenarios();
    }

    @Test
    public void test(){
        start(new StatisticsSeeNumberRegisteredUsersSteps());
    }
