...
import steps.StatisticSeeTop5FavoritesSpotsSteps;

@RunWith(Parameterized.class)
public class StatisticsSeeTop5FavoritesSpotsFeatureTest extends GreenCoffeeTest {
    @Rule
    public ActivityTestRule<GuestDashboardActivity> activity = new ActivityTestRule<>(GuestDashboardActivity.class);

    public StatisticsSeeTop5FavoritesSpotsFeatureTest(ScenarioConfig scenario) {
        super(scenario);
    }
    ...
    public static Iterable<ScenarioConfig> data() throws IOException {
        return new GreenCoffeeConfig()
                .withFeatureFromAssets("assets/features/statisticsSeeTop5FavoritesSpots.feature")
                .scenarios();
    }

    @Test
    public void test(){
        start(new StatisticSeeTop5FavoritesSpotsSteps());
    }
