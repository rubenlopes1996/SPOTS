...
public class StatisticsSeeTop5MustUsedSpotsSteps extends GreenCoffeeSteps {
    ...
    public void i_see_text(String arg1, String arg2, String arg3, String arg4, String arg5) {
        onViewWithId(R.id.textViewMustUsedSpot1).contains(arg1);
        onViewWithId(R.id.textViewMustUsedSpot2).contains(arg2);
        onViewWithId(R.id.textViewMustUsedSpot3).contains(arg3);
        onViewWithId(R.id.textViewMustUsedSpot4).contains(arg4);
        onViewWithId(R.id.textViewMustUsedSpot5).contains(arg5);
    }
